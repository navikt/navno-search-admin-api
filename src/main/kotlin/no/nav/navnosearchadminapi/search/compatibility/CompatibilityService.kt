package no.nav.navnosearchadminapi.search.compatibility
...
import no.nav.navnosearchadminapi.search.compatibility.filters.fasettFilters
import no.nav.navnosearchadminapi.search.compatibility.filters.fylkeFilters
import no.nav.navnosearchadminapi.search.compatibility.filters.innholdFilters
import no.nav.navnosearchadminapi.search.compatibility.filters.nyheterFilters
import no.nav.navnosearchadminapi.search.compatibility.filters.tidsperiodeFilters
import no.nav.navnosearchadminapi.search.compatibility.mapper.SearchResultMapper
