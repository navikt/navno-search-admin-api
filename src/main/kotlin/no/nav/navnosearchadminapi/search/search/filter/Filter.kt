package no.nav.navnosearchadminapi.search.search.filter
...
import no.nav.navnosearchadminapi.search.search.existsQuery
import no.nav.navnosearchadminapi.search.search.rangeQuery
import no.nav.navnosearchadminapi.search.search.termQuery
