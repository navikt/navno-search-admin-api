package no.nav.navnosearchadminapi.admin.validation

import no.nav.navnosearchadminapi.admin.consumer.kodeverk.KodeverkConsumer
...
import no.nav.navnosearchadminapi.common.exception.MissingIdException
import no.nav.navnosearchadminapi.common.utils.HREF
import no.nav.navnosearchadminapi.common.utils.ID
import no.nav.navnosearchadminapi.common.utils.INGRESS
import no.nav.navnosearchadminapi.common.utils.METADATA
import no.nav.navnosearchadminapi.common.utils.METADATA_AUDIENCE
import no.nav.navnosearchadminapi.common.utils.METADATA_CREATED_AT
import no.nav.navnosearchadminapi.common.utils.METADATA_FYLKE
import no.nav.navnosearchadminapi.common.utils.METADATA_LANGUAGE
import no.nav.navnosearchadminapi.common.utils.METADATA_LAST_UPDATED
import no.nav.navnosearchadminapi.common.utils.METADATA_METATAGS
import no.nav.navnosearchadminapi.common.utils.TEXT
import no.nav.navnosearchadminapi.common.utils.TITLE
import no.nav.navnosearchadminapi.common.utils.enumContains
import no.nav.navnosearchadminapi.common.utils.enumDescriptors
