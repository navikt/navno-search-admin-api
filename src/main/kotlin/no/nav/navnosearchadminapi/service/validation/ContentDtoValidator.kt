...
import no.nav.navnosearchadminapi.utils.HREF
import no.nav.navnosearchadminapi.utils.ID
import no.nav.navnosearchadminapi.utils.INGRESS
import no.nav.navnosearchadminapi.utils.METADATA
import no.nav.navnosearchadminapi.utils.METADATA_AUDIENCE
import no.nav.navnosearchadminapi.utils.METADATA_CREATED_AT
import no.nav.navnosearchadminapi.utils.METADATA_FYLKE
import no.nav.navnosearchadminapi.utils.METADATA_LANGUAGE
import no.nav.navnosearchadminapi.utils.METADATA_LAST_UPDATED
import no.nav.navnosearchadminapi.utils.METADATA_METATAGS
import no.nav.navnosearchadminapi.utils.TEXT
import no.nav.navnosearchadminapi.utils.TITLE
