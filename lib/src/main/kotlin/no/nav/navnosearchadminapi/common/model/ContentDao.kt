...
data class ContentDao(
    ...
    @Field(type = FieldType.Object) val titleSynonyms: MultiLangField? = null,
    @Field(type = FieldType.Object) val ingressSynonyms: MultiLangField? = null,
    @Field(type = FieldType.Object) val allText: MultiLangField? = null,
