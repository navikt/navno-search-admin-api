...
fun dummyContentDao(
    ...
    return ContentDao(
        ...
        title = MultiLangField(value = title, language = language),
        ingress = MultiLangField(value = ingress, language = language),
        text = MultiLangField(value = text, language = language),
        allText = MultiLangField(value = "$title $ingress $text", language = language),
